    ...
    <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex justify-start items-center">
          ...
          <a href="https://aug28.cc/vp" className="flex items-center justify-between mr-4">
            <img
              src="https://uploads-ssl.webflow.com/6233cf47f232ad66c4026dcb/647198fa3090a633cf8a6138_Variant%20Perception%20Logo%20Design-cropped.svg"
              className="mr-3 h-8"
              alt="Variant Perception Logo"
            />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Variant Perception</span>
          </a>
